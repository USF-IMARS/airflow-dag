...
# # === EXTRACT INPUT FILES ===
# # ===========================================================================
# # NOTE: GIS_FILES need to be removed so they don't get accidentally ingested.
# unzip_wv2_ingest = IMaRSETLBashOperator(
#     task_id="unzip_wv2_ingest",
#     dag=this_dag,
#     bash_command="""
#         unzip {{ params.wv2_batch_zip }} -d {{ params.unzipped_dir }} &&
#         rm -r {{ params.unzipped_dir }}/*/*/GIS_FILES
#     """,
#     inputs={
#         'wv2_batch_zip': 'product_id=6'  # TODO: AND date_time='{{ts}} ?
#     },
#     outputs={
#         'unzipped_dir': {
#             "sql": "area_id=5"
#         }
#         # how to do outputs without generated filenames?
#     }
# )
# #
