...
with this_dag as dag:
    ...
    fgbnms_csvs2graphite = BashOperator(
        ...
        bash_command="""
            python2 \
            /home/airflow/dags/imars_dags/imars_dags/dags/csvs_to_graphite/py_scripts/fgbnms_csvs2graph.py
        """,
    )
    fgb_river_ts = BashOperator(
        ...
        bash_command="""
            python2 \
            /home/airflow/dags/imars_dags/imars_dags/dags/csvs_to_graphite/py_scripts/fgb_river_ts.py
        """,
    )
    fgb_sat_region = BashOperator(
        ...
        bash_command="""
            python2 \
            /home/airflow/dags/imars_dags/imars_dags/dags/csvs_to_graphite/py_scripts/fgb_sat_region.py
        """,
    )
    ...
    fk_river_ts = BashOperator(
        ...
        bash_command="""
            python2 \
            /home/airflow/dags/imars_dags/imars_dags/dags/csvs_to_graphite/py_scripts/fk_river_ts.py
        """,
    )
